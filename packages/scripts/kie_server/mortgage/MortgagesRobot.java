...
//DEPS org.kie.server:kie-server-client:7.60.0.Final org.kie.workbench.playground:mortgage-process:7.60.0.Final
//JAVA 11
...
public class MortgagesRobot {
    ...
    private static final String ARTIFACTID = "mortgage-process";
    ...
    public static void main(String[] args) {
        ...
        if(container.getResult() == null) {
            ...
            System.out.println("Container is being created, run again in a few seconds to start processes instances...");
            System.exit(0);
        }
